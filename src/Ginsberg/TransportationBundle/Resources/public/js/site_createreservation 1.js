      ...
      //Save original "until" date so that we can toggle it
      ...
      if ($('#Reservation_destination_id').val() != '') {
        //code
        $('.destination_id').addClass('show');
        $('.destination_id').removeClass('hide');
      }

      if ($('#Reservation_destination').val() != '') {
        //code
      ...
      $('#Reservation_program_id').change(function() {
        ...
        if ($('#Reservation_program_id option:selected').val() == '0' || $('#Reservation_program_id option:selected').val() == '' || $('#Reservation_program_id option:selected').val() == undefined) {
